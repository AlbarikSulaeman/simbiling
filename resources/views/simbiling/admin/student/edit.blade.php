...
@endif
                <div class="container">
                    <h5 class="sidebar-heading" ><a href="/simbiling/role"style="color: black; text-decoration: none;"><-kembali</a></h5>
                    <main class="form-register">
                        <form action="/simbiling/role/edit/{{$role->_id}}" method="POST">
                           @csrf
                           
                            <h1 class="h3 mb-3 fw-normal">Edit Content</h1>

                            <div class="form-floating">
                                <input type="text" name="role" class="form-control mt-2" id="role" placeholder="Name" value="{{$role->role}}">
